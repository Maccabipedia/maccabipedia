"""Publish the Lua modules to PRODUCTION. Separate flow, separate approval.
    ...
    uv run python infra/lua_modules/deploy_modules_prod.py --check
    uv run python infra/lua_modules/deploy_modules_prod.py --publish
    uv run python infra/lua_modules/deploy_modules_prod.py --publish --with-docs
    uv run python infra/lua_modules/deploy_modules_prod.py --probe
