"""Turn the day template into ONE #invoke that emits the whole widget.
    ...
    uv run python infra/lua_modules/convert_day_to_tabber.py --local
    uv run python infra/lua_modules/convert_day_to_tabber.py --local --dates 22-08,01-01
...
ROLLBACK = Path('infra/lua_modules/fixtures/day_template_tabber_rollback.json')
...
def main() -> None:
    ...
    print('  uv run python infra/lua_modules/compare_day_widget.py')
