...
templates of the same kind 2026-09-19 (PR #200).
    ...
    uv run python infra/lua_modules/convert_referee_section.py --local
    uv run python infra/lua_modules/compare_referee_leaderboards.py
    uv run python infra/lua_modules/compare_referee_leaderboards.py --selftest
