"""The baseline the rewrite has to reproduce, and a comparison that can fail.
    ...
    uv run python infra/lua_modules/capture_golden_numbers.py capture
    uv run python infra/lua_modules/capture_golden_numbers.py verify
    uv run python infra/lua_modules/capture_golden_numbers.py selftest
...
FIXTURE = Path('infra/lua_modules/fixtures/golden_numbers.json')
