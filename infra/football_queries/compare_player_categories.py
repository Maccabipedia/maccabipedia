"""Player-category pages: the old leaderboard boxes against the one invoke, on production.
    ...
    uv run python infra/football_queries/compare_player_categories.py
    uv run python infra/football_queries/compare_player_categories.py --selftest
    uv run python infra/football_queries/compare_player_categories.py --print
