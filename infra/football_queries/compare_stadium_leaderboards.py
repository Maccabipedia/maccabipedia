"""Old stadium leaderboard boxes against the one-invoke tabbers, on production.
    ...
    uv run python infra/football_queries/compare_stadium_leaderboards.py --sandbox
    uv run python infra/football_queries/compare_stadium_leaderboards.py --sandbox --selftest
    uv run python infra/football_queries/compare_stadium_leaderboards.py --full
...
BLOCKS_FILE = Path('infra/football_queries/Module_FootballStatsBlocks.lua')
