"""The published numbers on every day page, before and after migrating them.
    ...
    uv run python infra/football_queries/capture_day_pages.py capture
    uv run python infra/football_queries/capture_day_pages.py verify
    uv run python infra/football_queries/capture_day_pages.py selftest
...
FIXTURE = Path('infra/football_queries/fixtures/day_pages_baseline.json')
