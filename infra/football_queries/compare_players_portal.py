"""The players portal's leaderboards: old template boxes against the two invokes, on production.
    ...
    uv run python infra/football_queries/compare_players_portal.py
    uv run python infra/football_queries/compare_players_portal.py --selftest
    uv run python infra/football_queries/compare_players_portal.py --print
