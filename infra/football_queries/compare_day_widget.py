"""Compare the one-invoke tabber widget with the <shtml> strip it replaces.
    ...
    uv run python infra/football_queries/compare_day_widget.py
    uv run python infra/football_queries/compare_day_widget.py --dates 22-08,25-12
    uv run python infra/football_queries/compare_day_widget.py --all
