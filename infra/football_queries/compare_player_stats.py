"""Player page statistics columns: the query templates against Module:FootballPlayerStats - batched.
    ...
    uv run python infra/football_queries/compare_player_stats.py [--limit N] [--batch 4]
    uv run python infra/football_queries/compare_player_stats.py --selftest
    uv run python infra/football_queries/compare_player_stats.py --print
